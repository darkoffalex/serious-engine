...
DLLFUNCTION(OGL, GLuint, glCreateShader, (GLenum shaderType), 0, 0);
...
DLLFUNCTION(OGL, void, glGetShaderInfoLog, (GLuint shader, GLsizei maxLength, GLsizei* length, GLchar* infoLog), 0, 0);
...
DLLFUNCTION(OGL, void, glGetProgramInfoLog, (GLuint program, GLsizei maxLength, GLsizei* length, GLchar* infoLog), 0, 0);
...
DLLFUNCTION(OGL, void, glUniform1i, (GLint location, GLint v0), 0, 0);
